...
<a class="download-button pdf" id="download-pdf" href="http://azu.github.io/promises-book/javascript-promise-book.pdf" download="[azu]javascript-promise-book">PDF版をダウンロード</a> <a class="download-button source-code" href="https://github.com/azu/promises-book/">ソースコードをダウンロード</a>
</div>
++++
